...
import { INeo4JAdapterInterface } from "./provided_port/neo4j.adapter.interface";
import { ConfigService } from "@nestjs/config";

@Injectable()
export class Neo4JAdapter implements INeo4JAdapterInterface, OnApplicationShutdown {
    ...
    constructor(
        ...
        const driver = this.neo4JDriverProvider.getDriver();
        if (!driver) {
            throw Error("Neo4j drvier not created");
        }
        this.driver = driver;
